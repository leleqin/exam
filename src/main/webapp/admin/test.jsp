...
/*
        ...
        $.ajax({
            ...
            <td><button class="layui-btn layui-btn-sm layui-icon" onclick="updateTest()">&#xe642;编辑</button>
...
*/
        ...
        $.ajax({
            ...
            <td><button class="layui-btn layui-btn-sm layui-icon" onclick="updateTest(` + data[i]['tid'] + `)">&#xe642;编辑</button>
